...
void system_mcu_clocks_config(void)
{
    ...
    // sdiom最高输出98Mhz, sd bus分频固定1分频
    mmc_set_sd_bus_clk_div(0x1);
}
...
uint32_t clocks_get_spi_frequency(void)
{
    return clocks_get_ccrg_clk_freq(CLOCKS_CCRG_MODULE_MCU_PERP_SPI);
}
