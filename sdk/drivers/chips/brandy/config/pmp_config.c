...
typedef enum {
    ...
    L2RAM_IDX                  = 3,
    SHARE_MEM_IDX              = 4,
    BT_RAM_APP_MAPPING_IDX     = 5,
    REG_ADDR_0_IDX             = 6,  /* reg 0x5x */
    REG_ADDR_1_IDX             = 7,
    REG_ADDR_1_SECOND_IDX      = 8,  /* reg 0xa3 */
...
static void pmp_init_config(void)
{
    ...
    g_region_attr[ITCM_IDX].addr = 0;
    g_region_attr[ITCM_IDX].size = 0x40000;
    ...
    g_region_attr[L2RAM_IDX].size = 0x400000;
#else
    g_region_attr[L2RAM_IDX].addr = 0x60200000;
    g_region_attr[L2RAM_IDX].size = 0x200000;
#endif
    ...
    g_region_attr[REG_ADDR_1_IDX].addr = 0xA3000000;
    g_region_attr[REG_ADDR_1_IDX].size = 0x10000;
    ...
    g_region_attr[REG_ADDR_1_SECOND_IDX].idx = REG_ADDR_1_SECOND_IDX;
    g_region_attr[REG_ADDR_1_SECOND_IDX].addr = 0xB0000000;
    g_region_attr[REG_ADDR_1_SECOND_IDX].size = 0x10000000;
    g_region_attr[REG_ADDR_1_SECOND_IDX].conf.pmp_attr = PMP_ATTR_DEVICE_NO_BUFFERABLE;
    g_region_attr[REG_ADDR_1_SECOND_IDX].conf.rwx_permission = (rwx_permission_t)PMPCFG_RW_NEXECUTE;
    g_region_attr[REG_ADDR_1_SECOND_IDX].conf.addr_match = PMPCFG_ADDR_MATCH_NAPOT;
    g_region_attr[REG_ADDR_1_SECOND_IDX].conf.lock = true;
...
#ifdef SUPPORT_GPU_GMMU
void pmp_configure_gmmu_region(int32_t flag)
{
    pmp_conf_t gpu_gmmu_pmp_region_attr[1] = {0};
    gpu_gmmu_pmp_region_attr[0].idx = L2RAM_SECOND_IDX;
    if (flag) {
        gpu_gmmu_pmp_region_attr[0].addr = 0x61000000;
        gpu_gmmu_pmp_region_attr[0].size = 0x1000000;
        gpu_gmmu_pmp_region_attr[0].conf.pmp_attr = PMP_ATTR_NO_BUFFERABLE_AND_NO_CACHEABLE;
        gpu_gmmu_pmp_region_attr[0].conf.rwx_permission = (rwx_permission_t)PMPCFG_RW_EXECUTE;
        gpu_gmmu_pmp_region_attr[0].conf.addr_match = PMPCFG_ADDR_MATCH_NAPOT;
        gpu_gmmu_pmp_region_attr[0].conf.lock = 0;
    }
    uapi_pmp_config(gpu_gmmu_pmp_region_attr, 1);
}
#endif
