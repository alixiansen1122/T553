...
#elif PRE_ASIC
#ifdef CONFIG_PRODUCT_EVB_GNSS
#include "board_evb_gnss.h"
#elif CONFIG_PRODUCT_EVB_VOLTE
#include "board_evb_volte.h"
#elif CONFIG_PRODUCT_EVB_NFC
#include "board_evb_nfc.h"
#elif CONFIG_PRODUCT_EVB_DITING
#include "board_evb_diting.h"
#else
#include "board_evb.h"
#endif
#endif
