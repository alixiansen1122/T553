...
/* manufacturer id - driver version id - driver id (don't care for the moment) */
#define LCD_ST7367_360X480_SCREEN_ID 0xFFFFFF

const combo_dev_cfg_t g_panel_st7367_360x480_60_config = {
    .devno = 0,
    .lane_id = {0, -1},
    .out_mode = OUT_MODE_DSI_VIDEO,
    .out_format = OUT_FORMAT_RGB_24BIT,
    .sync_info = {
        .hsa_pixels   = 2,    // hsa 2 pixels
        .hbp_pixels   = 20,   // hbp 20 pixels
        .hact_pixels  = 360,  // hact 360 pixels
        .hfp_pixels   = 20,   // hfp 20 pixels
        .vsa_lines    = 1,    // vsa 1 lines
        .vbp_lines    = 6,    // vbp 6 lines
        .vact_lines   = 480,  // vact 480 lines
        .vfp_lines    = 6,    // vfp 6 lines
    },
    .phy_data_rate = 288,     // 288Mbps
    .pixel_clk = 12000,       // 12000KHz
};
...
/* init sequence for ST7367 360*480 lcd */
const lcd_cmd_sequ g_st7367_360x480_screen_init_on[] = {
    {1, 2, {0xF0, 0xC3}, 0},
    {1, 2, {0xF0, 0x96}, 0},
    {1, 2, {0xF0, 0xA5}, 0},
    {1, 5, {0xC1, 0x11, 0x08, 0xAD, 0x13}, 0},
    {1, 5, {0xC2, 0x11, 0x08, 0xAD, 0x13}, 0},
    {1, 5, {0xC3, 0x22, 0x02, 0x44, 0x04}, 0},
    {1, 5, {0xC4, 0x44, 0x04, 0x44, 0x04}, 0},
    {1, 3, {0xC5, 0x4E, 0x80}, 0},  /* #VCOM 0.975 2025 4 28 */
    {1, 2, {0xD6, 0x00}, 0},
    {1, 2, {0xD7, 0x00}, 0},
    {1, 15, {0xE0, 0xD0, 0x08, 0x0D, 0x0A, 0x08, 0x05, 0x35, 0x33, 0x4C, 0x08, 0x13, 0x14, 0x2D, 0x32}, 0},
    {1, 15, {0xE1, 0xD0, 0x08, 0x0D, 0x0A, 0x08, 0x05, 0x35, 0x33, 0x4C, 0x08, 0x13, 0x14, 0x2D, 0x32}, 0},
    {1, 15, {0xE5, 0x58, 0xF5, 0x66, 0x33, 0x22, 0x25, 0x10, 0x77, 0x77, 0x77, 0x77, 0x77, 0x77, 0x77}, 0},
    {1, 15, {0xE6, 0x58, 0xF5, 0x66, 0x33, 0x22, 0x25, 0x10, 0x77, 0x77, 0x77, 0x77, 0x77, 0x77, 0x77}, 0},
    {1, 7, {0xEC, 0x00, 0x55, 0x00, 0x00, 0x00, 0x08}, 0},
    {1, 2, {0x36, 0x0C}, 0},
    {1, 2, {0x3A, 0x07}, 0},
    {1, 2, {0xB2, 0x09}, 0},
    {1, 2, {0xB3, 0x01}, 0},
    {1, 2, {0xB4, 0x01}, 0},
    {1, 5, {0xB5, 0x00, 0x08, 0x00, 0x08}, 0},
    {1, 3, {0xB6, 0xEF, 0x2C}, 0},
    {1, 3, {0xA4, 0xC0, 0x63}, 0},
    {1, 10, {0xA5, 0x00, 0x00, 0x00, 0x00, 0x00, 0x0B, 0x2A, 0xBA, 0x02}, 0},
    {1, 10, {0xA6, 0x00, 0x00, 0x00, 0x00, 0x00, 0x0B, 0x2A, 0xBA, 0x02}, 0},
    {1, 8, {0xBA, 0x58, 0x1A, 0x45, 0x02, 0x22, 0x01, 0x00}, 0}, /* #2025 5 9 Modify STV0 */
    {1, 9, {0xBB, 0x00, 0x20, 0x00, 0x25, 0x83, 0x87, 0x18, 0x00}, 0},
    {1, 9, {0xBC, 0x00, 0x24, 0x00, 0x25, 0x83, 0x87, 0x18, 0x00}, 0},
    {1, 12, {0xBD, 0x21, 0x12, 0x99, 0xFF, 0x45, 0x36, 0x63, 0x54, 0xAB, 0xFF, 0x07}, 0},
    {1, 2, {0xED, 0xC3}, 0},
    {1, 4, {0xE4, 0x40, 0x0F, 0x2F}, 0},
    {1, 2, {0x35, 0x00}, 0},
    {1, 1, {0x21}, 0},
    {1, 1, {0x11}, 120},
    {1, 1, {0x29}, 120},
...
const lcd_cmds_sequ g_st7367_360x480_screen_init_on_cmds = {
    .cmd = g_st7367_360x480_screen_init_on,
    .cmd_cnt = array_size(g_st7367_360x480_screen_init_on),
};
...
const lcd_drv_cfg g_lcd_driver_ops[] = {
    {
        ...
        .bus_cfg              = &g_panel_st7367_360x480_60_config,
        .x_start              = 0,
        .y_start              = 0,
        .fps                  = 60,
        .lcd_id               = LCD_ST7367_360X480_SCREEN_ID,
        .display_on_cmds      = &g_st7367_360x480_screen_init_on_cmds,
