...
typedef enum {
    ...
    IPC_ACTION_BT_SERVICE_ON = 38, // !< Used by BT core to inform app core Calibration end in wear.
    ...
    IPC_ACTION_UART_AGENT_TX = 48,           // !< Used by APP core to send data to BT core.
    IPC_ACTION_UART_AGENT_RX = 49,           // !< Used by APP core to rcv data to BT core.
