 ...
 * Description: product EVB4 standard config
 * Author: @CompanyNameTag
 * Create:  2023-03-07
 */
#ifndef PRODUCT_EVB4_STANDARD_CONFIG_H
#define PRODUCT_EVB4_STANDARD_CONFIG_H
...
#endif
#if defined(CONFIG_NORFLASH_SIZE) && (CONFIG_NORFLASH_SIZE == 16)
#define DTB_IMAGE_PAGES                     0
#define RECOVERY_IMAGE_PAGES                256
#define RESERVE_IMAGE_PAGES                 64
#define BT_IMAGE_PAGES                      112
#define HIFI0_IMAGE_PAGES                   192
#define HIFI0_CODEC_PAGES                   448
#define APP_IMAGE_PAGES                     2048
#elif defined(CONFIG_NORFLASH_SIZE) && (CONFIG_NORFLASH_SIZE == 4)
#define DTB_IMAGE_PAGES                     0
#define RECOVERY_IMAGE_PAGES                64
#define RESERVE_IMAGE_PAGES                 0
#define BT_IMAGE_PAGES                      112
#define HIFI0_IMAGE_PAGES                   112
#define HIFI0_CODEC_PAGES                   64
#define APP_IMAGE_PAGES                     512
#else
...
#ifndef CONFIG_PSRAM_DENSITY_MB
#define PSRAM_DENSITY_MB                    32
#else
#define PSRAM_DENSITY_MB                    CONFIG_PSRAM_DENSITY_MB
#endif
...
#elif defined(GPU_SUPPORT_VIDEO_MODE)
#define RESOLUTION_WIDTH                  360
...
#define BUILTIN_SND_OUT_PORT                       0x10  // 参考 soc_uapi_sound.h 中 UAPI_SND_OUT_PORT_I2S0 枚举
#else
...
#define MP3_ENC_BIT_RATE 					16000 // mp3编码码率

// volume
#define DEFAULTE_AI_VOL_DB_INTERGER 		24    // 默认的AI的音量值整数部分，单位DB
/**
 * @}
 */
#endif
