...
static void hw_init(void)
{
    ...
    uapi_pin_set_mode(S_AGPIO_R10, (pin_mode_t)HAL_PIO_FUNC_GPIO);
    uapi_gpio_set_dir(S_AGPIO_R10, GPIO_DIRECTION_OUTPUT);
    uapi_gpio_set_val(S_AGPIO_R10, GPIO_LEVEL_HIGH);

    uapi_pin_set_mode(S_AGPIO_R9, (pin_mode_t)HAL_PIO_FUNC_GPIO);
    uapi_gpio_set_dir(S_AGPIO_R9, GPIO_DIRECTION_OUTPUT);
    uapi_gpio_set_val(S_AGPIO_R9, GPIO_LEVEL_LOW);
    uapi_tcxo_delay_ms(100);
    uapi_gpio_set_val(S_AGPIO_R9, GPIO_LEVEL_HIGH);
    ...
    uapi_pin_set_mode(S_AGPIO_L18, (pin_mode_t)HAL_PIO_FUNC_GPIO);
    uapi_gpio_set_dir(S_AGPIO_L18, GPIO_DIRECTION_OUTPUT);
    uapi_gpio_set_val(S_AGPIO_L18, GPIO_LEVEL_HIGH);

    uapi_pin_set_mode(S_AGPIO_L23, (pin_mode_t)HAL_PIO_FUNC_GPIO);
    uapi_gpio_set_dir(S_AGPIO_L23, GPIO_DIRECTION_OUTPUT);
    uapi_gpio_set_val(S_AGPIO_L23, GPIO_LEVEL_HIGH);

    uapi_pin_set_mode(S_AGPIO_L24, (pin_mode_t)HAL_PIO_FUNC_GPIO);
    uapi_gpio_set_dir(S_AGPIO_L24, GPIO_DIRECTION_OUTPUT);
    uapi_gpio_set_val(S_AGPIO_L24, GPIO_LEVEL_HIGH);
    uapi_tcxo_delay_ms(20);
    uapi_gpio_set_val(S_AGPIO_L24, GPIO_LEVEL_LOW);
...
{
    PRINT("board_poweron\r\n");
    uapi_pin_set_mode(S_AGPIO_L19, (pin_mode_t)HAL_PIO_FUNC_GPIO);
    uapi_gpio_set_dir(S_AGPIO_L19, GPIO_DIRECTION_OUTPUT);
    uapi_gpio_set_val(S_AGPIO_L19, GPIO_LEVEL_HIGH);
    PRINT("vdd 3v3 poweron\r\n");

    uapi_pin_set_mode(S_AGPIO_L20, (pin_mode_t)HAL_PIO_FUNC_GPIO);
    uapi_gpio_set_dir(S_AGPIO_L20, GPIO_DIRECTION_OUTPUT);
    uapi_gpio_set_val(S_AGPIO_L20, GPIO_LEVEL_HIGH);
    PRINT("vdd 1v8 poweron\r\n");
    uapi_tcxo_delay_ms(200); /* 200ms */
}
#endif
