...
HEADER_FIELDS_DESC = {
    ...
    'EI_ENTRY_ADDR': ((0x18, 0x18), (4, 8)),  # addr of the entry point of execution,
    ...
    'EI_EHSIZE': ((0x28, 0x34), (2, 2)),
    # size of this header (ELF file header -- known in advance but provided for ease of use),
...
SECTHEADER_FIELDS_DESC = {
    'SH_NAME': ((0x0, 0x0), (4, 4)),
    # an offset to a string in the .shstrtab section that describes the name of this particular section
