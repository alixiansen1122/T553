...
SAP_IDP_DIR=`realpath ${PROJECT_ROOT}/application/audio/sample_dsp_overlay/aef`
...
copy_chip_cfg()
{
    ...
    cp $sap_xt_dir/arch/$chip/lsp_aef $idp_xt_dir/arch/lsp/ -R
    rm -rf $idp_xt_dir/arch/lsp/lsp_aef/reset-vector.S
}
...
idp_install()
{
    ...
    local aef_comp_dir=${SAP_CORE_DIR}/component/effect/include
