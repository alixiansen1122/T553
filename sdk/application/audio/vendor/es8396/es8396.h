 ...
 * Description: header file for es8396 driver
 */
...
/* ES8396_REGISTER NAME_REG_REGISTER ADDR */
/*
...
/* Register 0x1D for Addr of shared register map */
...
#define ES8388_PLL_PWR_1_8V    0
#define ES8388_PLL_PWR_2_5V    1
#define ES8388_PLL_PWR_3_3V    2
...
typedef enum {
    ES8396_SAMPLE_RATE_8K = 8,
    ES8396_SAMPLE_RATE_16K = 16,
    ES8396_SAMPLE_RATE_32K = 32,
    ES8396_SAMPLE_RATE_48K = 48,
} es8396_sample_rate;
...
typedef enum {
    ES8396_RESOLUTION_16BIT = 16,
    ES8396_RESOLUTION_24BIT = 24,
} es8396_resolution;

typedef enum {
    ES8396_CLK_DIR_MASTER = 0,
    ES8396_CLK_DIR_SLAVE,
} es8396_clk_dir;

typedef enum {
    ES8396_STREAM_PLAYBACK = 0,
    ES8396_STREAM_CAPTURE,
} es8396_stream_dir;

typedef enum {
    ES8396_FORMAT_I2S = 0,
    ES8396_FORMAT_LEFT_J,
    ES8396_FORMAT_RIGHT_J,
    ES8396_FORMAT_DSP_A,
    ES8396_FORMAT_DSP_B
} es8396_format;

typedef struct {
    es8396_sample_rate sample_rate;
    es8396_resolution resolution;
    es8396_clk_dir clk_dir;
    es8396_format format;
} es8396_attr;

td_s32 drv_es8396_init(es8396_sdp sdp_id, const es8396_attr *attr);
