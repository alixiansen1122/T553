...
namespace OHOS {
static constexpr uint16_t TITLE_LABEL_DEFAULT_HEIGHT = 30;
...
static constexpr uint16_t TEXT_DISTANCE_TO_LEFT_SIDE = 50;
...
static constexpr int16_t BACK_BUTTON_HEIGHT = 50;
...
static constexpr uint16_t TEST_LABEL_WIDTH = 300;
static constexpr uint16_t TEST_LABEL_HEIGHT = 50;
static constexpr uint16_t TITLE_X = 150;
static constexpr uint16_t OPA_150 = 150;
static constexpr uint16_t OPA_50 = 50;
...
public:
    ...
    UILabel* GetTitleLabel(const char* titleName)
    {
        ...
        label->SetPosition(0, 0, HORIZONTAL_RESOLUTION / 2, TITLE_LABEL_DEFAULT_HEIGHT);
