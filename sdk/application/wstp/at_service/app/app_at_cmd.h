 ...
 * @if Eng
 * @brief  AT^NFCRESET
 * @par Description: NFC reset & initialize
 * @param  [in] No Param
 * @retval OK~                    Success
 * @retval ERR~                   Fail
 * @else
 * @brief  AT^NFCRESET
 * @par 说明: 执行NFC复位及初始化流程
 * @param  [in] 无参数
 * @retval OK~                    成功返回
 * @retval ERR~                   失败返回
 * @endif
...
/**
 * @if Eng
 * @brief  AT^NFCBUSINESSSTART
 * @par Description: start NFC business
 * @param  [in] business mode(0: mxxce, 1: rw)
 * @retval OK~                    Success
 * @retval ERR~                   Fail
 * @else
 * @brief  AT^NFCBUSINESSSTART
 * @par 说明: 开启NFC业务(0: MXX卡模拟, 1: 读卡器)
 * @param  [in] 开启模式
 * @retval OK~                    成功返回
 * @retval ERR~                   失败返回
 * @endif
...
/**
 * @if Eng
 * @brief  AT^NFCBUSINESSSTOP
 * @par Description: stop NFC business
 * @param  [in] No Param
 * @retval OK~                    Success
 * @retval ERR~                   Fail
 * @else
...
/**
 * @if Eng
 * @brief  AT^NFCMXXCESWITCHCARD
 * @par Description: switch NFC MXX CE card
 * @param  [in] target card index
 * @retval OK~                    Success
 * @retval ERR~                   Fail
 * @else
 * @brief  AT^NFCMXXCESWITCHCARD
 ...
 * @endif
 */
AT^NFCMXXCESWITCHCARD;

/**
 * @if Eng
 * @brief  AT^NFCOPENLOG
 * @par Description: open NFC log
 * @param  [in] No Param
 * @retval OK~                    Success
 * @retval ERR~                   Fail
 * @else
...
/**
 * @if Eng
 * @brief  AT^NFCCLOSELOG
 * @par Description: close NFC log
 * @param  [in] No Param
 * @retval OK~                    Success
 * @retval ERR~                   Fail
 * @else
...
/**
 * @if Eng
 * @brief  AT^NFCSENDNCICMD
 * @par Description: send NFC NCI cmd
 * @param  [in] cmd to send
 * @retval OK~                    Success
 * @retval ERR~                   Fail
 * @else
 * @brief  AT^NFCSENDNCICMD
