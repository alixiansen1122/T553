...
#elif LV_USE_VGU
    driver->draw_ctx_init = LvDrawVguCtxInit;
    driver->draw_ctx_deinit = LvDrawVguCtxDeinit;
    driver->draw_ctx_size = sizeof(LvDrawVguCtx);
#else
...
#if LV_CORE_TIMER_NO_PERIOD_LIMIT
    disp->refr_timer = lv_timer_create(_lv_disp_refr_timer, 0, disp);
#else
