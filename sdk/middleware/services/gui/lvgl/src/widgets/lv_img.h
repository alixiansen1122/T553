...
typedef struct {
    ...
    bool isLongTermCached;  /* Whether the img source data is long-term cached. */
#endif
 ...
 * @param  [in]  src    Pointer to src file path(only .bin or .jpg accepted depending on MACROS)
 */
 ...
 * @param  [in]  obj    Pointer to an image object
 * @param  [in]  src    Pointer to src file path(only .bin or .jpg accepted depending on MACROS)
 * @param  [in]  isLongTermCached    Whether the img source data is long-term cached.
 */
