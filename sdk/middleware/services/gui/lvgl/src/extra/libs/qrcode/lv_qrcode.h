...
/**
 * @brief  Set error correction level in a QR Code symbol. The default ecc level is qrcodegen_Ecc_MEDIUM.
 * @param  [in]  ecc    error correction level in a QR Code symbol.
 */
void lv_qrcode_set_ecc(enum qrcodegen_Ecc ecc);
/**********************
 *      MACROS
 **********************/
