 ...
 **********************/
#if LV_USE_IMG_EXT
#define ALIGN_GAP_H 50

static void BasicImgCreate(lv_obj_t* img, lv_blend_mode_t blendMode, uint8_t opa, uint8_t cf)
{
    if (cf == 0) {
...
static lv_obj_t* ImgFmtTest(lv_obj_t * parent, lv_obj_t* alignRef, lv_align_t refAlignment)
{
    lv_obj_t* img1 = lv_img_create(parent);
    BasicImgCreate(img1, LV_BLEND_MODE_SRC_OVER, 255, 0);
    ...
    BasicImgCreate(img2, LV_BLEND_MODE_SRC_OVER, 255, 1);
    ...
    BasicImgCreate(img3, LV_BLEND_MODE_SRC, 255, 2);
...
static lv_obj_t* ImgAlphaBlendTest(lv_obj_t* parent, lv_obj_t* alignRef, lv_align_t refAlignment)
{
    lv_obj_t* img1 = lv_img_create(parent);
    BasicImgCreate(img1, LV_BLEND_MODE_SRC_OVER, 255, 0);
    lv_obj_align_to(img1, alignRef, refAlignment, 0, ALIGN_GAP_H);
    ...
    lv_obj_t* img2 = lv_img_create(parent);
    BasicImgCreate(img2, LV_BLEND_MODE_SRC_OVER, 50, 0);
    lv_obj_align_to(img2, img1, LV_ALIGN_OUT_BOTTOM_MID, 0, ALIGN_GAP_H);
    lv_obj_t* label2 = lv_label_create(parent);
    lv_obj_align_to(label2, img2, LV_ALIGN_OUT_TOP_MID, 0, 0);
    lv_label_set_text(label2, "opa50 srcover");

    lv_obj_t* img3 = lv_img_create(parent);
    BasicImgCreate(img3, LV_BLEND_MODE_SRC, 50, 0);
    lv_obj_align_to(img3, img2, LV_ALIGN_OUT_BOTTOM_MID, 0, ALIGN_GAP_H);
    lv_obj_t* label3 = lv_label_create(parent);
    lv_obj_align_to(label3, img3, LV_ALIGN_OUT_TOP_MID, 0, 0);
    lv_label_set_text(label3, "opa50 src");

    lv_obj_t* img4 = lv_img_create(parent);
    BasicImgCreate(img4, LV_BLEND_MODE_SRC_IN, 50, 0);
    ...
    lv_label_set_text(label4, "opa50 srcin");

    lv_obj_t* img5 = lv_img_create(parent);
    BasicImgCreate(img5, LV_BLEND_MODE_DST_OVER, 50, 0);
    ...
    lv_label_set_text(label5, "opa50 dstover");

    lv_obj_t* img6 = lv_img_create(parent);
    BasicImgCreate(img6, LV_BLEND_MODE_DST_IN, 50, 0);
    ...
    lv_label_set_text(label6, "opa50 dstin");

    return img6;
}

static lv_obj_t* ImgTransformTest(lv_obj_t* parent, lv_obj_t* alignRef, lv_align_t refAlignment)
{
    lv_obj_t* img1 = lv_img_create(parent);
    BasicImgCreate(img1, LV_BLEND_MODE_SRC_OVER, 150, 0);
    TransformImg(img1, 0, 128);
    lv_obj_align_to(img1, alignRef, refAlignment, 0, ALIGN_GAP_H);
    lv_obj_t* label1 = lv_label_create(parent);
    lv_obj_align_to(label1, img1, LV_ALIGN_OUT_TOP_MID, 0, 0);
    ...
    lv_obj_t* img2 = lv_img_create(parent);
    BasicImgCreate(img2, LV_BLEND_MODE_SRC_OVER, 150, 0);
    TransformImg(img2, 0, 512);
    lv_obj_align_to(img2, img1, LV_ALIGN_OUT_BOTTOM_MID, 0, ALIGN_GAP_H);
    lv_obj_t* label2 = lv_label_create(parent);
    lv_obj_align_to(label2, img2, LV_ALIGN_OUT_TOP_MID, 0, 0);
    ...
    lv_obj_t* img3 = lv_img_create(parent);
    BasicImgCreate(img3, LV_BLEND_MODE_SRC_OVER, 150, 0);
    TransformImg(img3, 900, 256);
    lv_obj_align_to(img3, img2, LV_ALIGN_OUT_BOTTOM_MID, 0, ALIGN_GAP_H);
    lv_obj_t* label3 = lv_label_create(parent);
    lv_obj_align_to(label3, img3, LV_ALIGN_OUT_TOP_MID, 0, 0);
    ...
    lv_obj_t* img4 = lv_img_create(parent);
    BasicImgCreate(img4, LV_BLEND_MODE_SRC_OVER, 150, 0);
    TransformImg(img4, 900, 128);
    lv_obj_align_to(img4, img3, LV_ALIGN_OUT_BOTTOM_MID, 0, ALIGN_GAP_H);
    lv_obj_t* label4 = lv_label_create(parent);
    lv_obj_align_to(label4, img4, LV_ALIGN_OUT_TOP_MID, 0, 0);
...
static lv_obj_t* JpegTest(lv_obj_t* parent, lv_obj_t* alignRef, lv_align_t refAlignment)
{
    lv_obj_t* img1 = lv_img_create(parent);
...
static void ImgTestSetUp(lv_obj_t* parent)
{
    LV_LOGI("=========[%s: %d] Begin Img Test=========\n", __FUNCTION__, __LINE__);
...
{
    uint8_t alpha = ((color >> 24) * opa) / LV_OPA_COVER; // 24: alpha shift
...
static void TestSweepGradient(lv_obj_t* canvas, LvPaint* basePaint)
{
    static LvPaint paint = {0};
    paint = *basePaint;
    paint.fillAttr.shader.gradient.gradientType = GRADIENT_SWEEP;
    paint.fillAttr.shader.gradient.sweepGradient.centerX = 75;
    paint.fillAttr.shader.gradient.sweepGradient.centerY = 125;
    paint.fillAttr.shader.gradient.sweepGradient.startAngle = 90;

    uint32_t cmdNum = 5;
    uint32_t dataNum = 5;
    uint8_t c[5] = {CMD_MOVE_TO, CMD_HLINE_TO, CMD_VLINE_TO, CMD_HLINE_TO, CMD_CLOSE};
    float d[5] = {50, 100, 100, 150, 50};
...
static void TestLinearGradient(lv_obj_t* canvas, LvPaint* basePaint)
{
    static LvPaint paint = {0};
    paint = *basePaint;
    paint.fillAttr.shader.gradient.gradientType = GRADIENT_LINEAR;
    paint.fillAttr.shader.gradient.linearGradient.startX = 150;
    paint.fillAttr.shader.gradient.linearGradient.startY = 0;
    paint.fillAttr.shader.gradient.linearGradient.endX = 180;
...
static void TestRadialGradient(lv_obj_t* canvas, LvPaint* basePaint)
{
    // SPREAD_REFLECT
    static LvPaint paint = {0};
    paint = *basePaint;
    paint.fillAttr.shader.gradient.gradientType = GRADIENT_RADIAL;
    paint.fillAttr.shader.gradient.radialGradient.centerX = 275;
    paint.fillAttr.shader.gradient.radialGradient.centerY = 125;
    paint.fillAttr.shader.gradient.radialGradient.radius = 20;
    paint.fillAttr.shader.gradient.gradientSpread = SPREAD_REFLECT;

    uint32_t cmdNum = 5;
    uint32_t dataNum = 5;
    uint8_t c[5] = {CMD_MOVE_TO, CMD_HLINE_TO, CMD_VLINE_TO, CMD_HLINE_TO, CMD_CLOSE};
    float d[5] = {250, 100, 300, 150, 250};
    ...
    LvCanvasExtSetPathData(canvas, cmdNum, c, dataNum, d);
    LvMatrix mat = {{1, 0, 100, 0, 1, 0, 0, 0, 1}};
...
static void TestGradient(lv_obj_t* canvas)
{
    ...
    InitBasicStrokeAttr(&paint.strokeAttr, RED, 5, 0, JOIN_BEVEL);

    static LvColorStop stops[3] = {{0, BLUE}, {0.5, ORANGE}, {1, GREEN}};
    paint.fillAttr.shader.gradient.stops = stops;
    paint.fillAttr.shader.gradient.stopCount = 3;
...
static void TestDrawLine(lv_obj_t* canvas)
{
    ...
    InitBasicStrokeAttr(&paint.strokeAttr, GREEN, 10, 0, 0);
...
static void TestJoinType(lv_obj_t* canvas)
{
    ...
    paint.isAntialiased = false;
    paint.style = STROKE_STYLE;
    InitBasicStrokeAttr(&paint.strokeAttr, GREEN, 10, 0, JOIN_BEVEL);

    uint32_t cmdNum = 3;
    uint32_t dataNum = 5;
    uint8_t c[3] = {CMD_MOVE_TO, CMD_HLINE_TO, CMD_LINE_TO};
    float d[5] = {50, 60, 90, 50, 100};
    ...
    paint.strokeAttr.joinType = JOIN_MITER;
    paint.strokeAttr.miterLimit = 50;
...
{
    static LvPaint paint = {0};
    lv_point_t center = {375, 200};
    paint.isAntialiased = true;
    paint.style = STROKE_STYLE;
    InitBasicStrokeAttr(&paint.strokeAttr, ORANGE, 5, 0, JOIN_BEVEL);

    LvCanvasExtDrawArc(canvas, center, 10, 0, 90, &paint);
    LvCanvasExtDrawArc(canvas, center, 10, 90, 180, &paint);
    LvCanvasExtDrawArc(canvas, center, 10, 180, 360, &paint);

    LvCanvasExtDrawArc(canvas, center, 20, 290, 30, &paint);
    LvCanvasExtDrawArc(canvas, center, 30, 10, 360, &paint);
    LvCanvasExtDrawArc(canvas, center, 40, 540, 630, &paint);
}
...
static void TestPattern(lv_obj_t* canvas)
{
    ...
    uint32_t dataNum = 5;
    uint8_t c[5] = {CMD_MOVE_TO, CMD_HLINE_TO, CMD_VLINE_TO, CMD_HLINE_TO, CMD_CLOSE};
    float d[5] = {0, 0, 90, 90, 0}; // 90: coordinate
    LvCanvasExtSetPathData(canvas, cmdNum, c, dataNum, d);
...
static void CanvasExtTestSetUp(lv_obj_t* parent)
{
    LV_LOGI("=========[%s: %d] Begin CanvasExt Test=========\n", __FUNCTION__, __LINE__);
    lv_obj_t* canvas = LvCanvasExtCreate(parent);

#if LV_USE_TRANSFORM_EXT
    LvCanvasExtTranslate(canvas, (LvVector3){-5.0f, 20.0f, 0.0f});
    LvCanvasExtRotate(canvas, 90.0, (LvVector3){220.0f, 220.0f, 0.0f}, (LvVector3){220.0f, 220.0f, 1.0f});
    ...
    lv_obj_set_height(canvas, 500);
    lv_obj_set_width(canvas, 420);
    lv_obj_align_to(canvas, parent, LV_ALIGN_TOP_MID, 0, 0);
...
#if LV_USE_DEMO_WIDGETS_FONT_VECTOR
    LvInitFontExt();
    font_large = LvFontLoadExt(DEFAULT_VECTOR_FONT_FILENAME, 14); // 14: default font size
    font_normal = LvFontLoadExt(DEFAULT_VECTOR_FONT_FILENAME, 14); // 14: default font size
#else
...
#if LV_USE_DEMO_WIDGETS_FONT_VECTOR
        font_large = LvFontLoadExt(DEFAULT_VECTOR_FONT_FILENAME, 24); // 24: font size
#else
...
#if LV_USE_DEMO_WIDGETS_FONT_VECTOR
        font_normal = LvFontLoadExt(DEFAULT_VECTOR_FONT_FILENAME, 16); // 16: font size
#else
...
#if LV_USE_DEMO_WIDGETS_FONT_VECTOR
        font_large = LvFontLoadExt(DEFAULT_VECTOR_FONT_FILENAME, 20); // 20: font size
#else
...
#if LV_USE_DEMO_WIDGETS_FONT_VECTOR
        font_normal = LvFontLoadExt(DEFAULT_VECTOR_FONT_FILENAME, 14); // 14: font size
#else
...
#if LV_USE_DEMO_WIDGETS_FONT_VECTOR
        font_large = LvFontLoadExt(DEFAULT_VECTOR_FONT_FILENAME, 18); // 18: font size
#else
...
#if LV_USE_DEMO_WIDGETS_FONT_VECTOR
        font_normal = LvFontLoadExt(DEFAULT_VECTOR_FONT_FILENAME, 12); // 12: font size
#else
...
#if LV_USE_IMG_EXT
    lv_obj_t* t4 = lv_tabview_add_tab(tv, "Img");
    ImgTestSetUp(t4);
#endif
#if LV_USE_CANVAS_EXT
    lv_obj_t* t5 = lv_tabview_add_tab(tv, "CanvasExt");
    CanvasExtTestSetUp(t5);
#endif
 ...
 **********************/
#if LV_USE_HW_BLUR
static void BlurCb(lv_event_t * e)
{
    lv_obj_t* obj = lv_event_get_target(e);
    if(lv_obj_has_state(obj, LV_STATE_CHECKED)) {
        LvObjSetBackgroundBlur(obj, 10, true);
        LV_LOGI("[%s: %d] Blur Background\n", __FUNCTION__, __LINE__);
    } else {
        LvObjClearBackgroundBlur();
        LV_LOGI("[%s: %d] Clear Blur\n", __FUNCTION__, __LINE__);
    }
}
#endif
...
#if LV_USE_VGU
    LV_LOGI("[%s: %d] blur switch = %p\n", __FUNCTION__, __LINE__, sw2);
    lv_obj_add_event_cb(sw2, BlurCb, LV_EVENT_CLICKED, NULL);
#endif
