...
#ifndef GRAPHIC_UI_LIST_NESTED_H
#define GRAPHIC_UI_LIST_NESTED_H
#include "graphic_config.h"
#include "components/ui_list.h"

namespace OHOS {
class UIListNested : public UIList {
public:
    explicit UIListNested(uint8_t direction = VERTICAL);

    ~UIListNested() override {}
...
#endif // GRAPHIC_UI_LIST_NESTED_H
