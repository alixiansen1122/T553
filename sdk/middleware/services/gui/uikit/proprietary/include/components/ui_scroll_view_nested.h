...
#ifndef GRAPHIC_UI_SCROLL_NESTED_H
#define GRAPHIC_UI_SCROLL_NESTED_H
#include "graphic_config.h"
#include "components/ui_scroll_view.h"

namespace OHOS {
class UIScrollViewNested : public UIScrollView {
public:
    explicit UIScrollViewNested(uint8_t direction = VERTICAL);

    ~UIScrollViewNested() override {}
...
}; // class UIScrollViewNested
} // namespace OHOS
#endif // GRAPHIC_UI_SCROLL_NESTED_H
