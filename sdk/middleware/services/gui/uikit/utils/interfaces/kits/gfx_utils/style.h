...
enum : uint8_t {
    ...
    /** Border radius: The priority of STYLE_TOP_BORDER_RADIUS and STYLE_BOTTOM_BORDER_RADIUS is higher than that of
       STYLE_BORDER_RADIUS. */
    STYLE_BORDER_RADIUS,
    STYLE_TOP_BORDER_RADIUS,
    STYLE_BOTTOM_BORDER_RADIUS,
    /** Border color */
    STYLE_BORDER_COLOR,
    /** Border opacity */
    STYLE_BORDER_OPA,
...
public:
    ...
    /* extent style */
private:
    int16_t topBorderRadius_;
    int16_t bottomBorderRadius_;
};
