...
int64_t Style::GetStyle(uint8_t key) const
{
    switch (key) {
        ...
        case STYLE_TOP_BORDER_RADIUS:
            return topBorderRadius_ != 0 ? topBorderRadius_ : borderRadius_;
        case STYLE_BOTTOM_BORDER_RADIUS:
            return bottomBorderRadius_ != 0 ? bottomBorderRadius_ : borderRadius_;
...
void Style::SetStyle(uint8_t key, int64_t value)
{
    switch (key) {
        ...
        case STYLE_BORDER_RADIUS:
            ...
            break;
        case STYLE_TOP_BORDER_RADIUS:
            topBorderRadius_ = value;
            break;
        case STYLE_BOTTOM_BORDER_RADIUS:
            bottomBorderRadius_ = value;
            break;
        case STYLE_BORDER_COLOR:
