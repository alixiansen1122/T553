...
void TransformMap::Rotate(float angle, const Vector2<float>& pivot)
#else
...
#if ENABLE_SWEEP_CLOCK
void TransformMap::Rotate(float angle, const Vector3<float>& rotatePivotStart, const Vector3<float>& rotatePivotEnd)
#else
