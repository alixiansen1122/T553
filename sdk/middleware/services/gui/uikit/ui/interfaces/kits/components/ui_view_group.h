...
public:
    ...
    /**
     * @brief Removes and delete all children views recursively. The following points should be noted:
     *        1. If the group and its child views don't delete their child views in their destructior function,
     *           you can use this mehod safely.
     *        2. If the group or its child views delete (all/some of) their child views in their destructor function,
     *           don't delete it using this method unless it have been specially handled. for example:
     *           2.1 if delete all, You can delete it using this method:
     *               - UIPicker UITimePicker UIImagePicker UIDigitalClock UIRollerView UICoverFlow UIMenuItem UIList
     *                 UIOptionBox  UIVideo
     *           2.2 if delete some, You can delete it using this method, and need to delete other children mannually:
     *               - UICrossView UICardContainer UISlipflowView
     * @since 1.0
     * @version 1.0
     */
     ...
     *        must include the specified coordinates and is a visible top view that can respond to touch events,
     *        and the obtained target view must be the top view that includes the specified coordinates.
     *
