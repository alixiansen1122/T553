...
public:
    ...
    /** Invalid value for the truncate position */
    static constexpr uint16_t TEXT_TRUNCATE_END_INV = 0xFFFF;
    ...
    /**
     * @brief Sets whether enable truncate mode.
     *
     * @param isTruncateMode Sets whether enable truncate mode.
     * @since 1.0
     * @version 1.0
     */
    void SetTruncateMode(bool isTruncateMode)
    {
        isTruncateMode_ = isTruncateMode;
    }
    ...
    /**
     * @brief Obtains the index of the character from where text will be truncated based on
     *        the text rectangle and style.
     *
     * @param textRect Indicates the text rectangle.
     * @param style Indicates the text style.
     ...
     * @version 1.0
     */
    uint16_t GetTruncateIndex(const Rect& textRect, const Style& style);

    /**
     * @brief Set matrix.
     *
     * @param matrix The tramsform matrix.
     * @since 1.0
     * @version 1.0
     */
    void SetTransformMap(TransformMap& transMap)
    {
...
protected:
    ...
    static constexpr uint16_t MAX_LINE_COUNT = 70;
    ...
    virtual uint16_t GetLine(int16_t width, uint8_t letterSpace, uint16_t tailIndex, uint32_t& maxLineBytes);
    ...
    TransformMap* transMap_ = nullptr;
    bool isTruncateMode_ : 1;
private:
