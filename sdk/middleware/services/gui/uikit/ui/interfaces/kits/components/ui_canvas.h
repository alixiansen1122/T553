...
public:
    ...
    Paint()
        : style_(PaintStyle::STROKE_FILL_STYLE), fillColor_(Color::Black()),
          ...
          rotateAngle_(0), scaleRadioX_(1.0f), scaleRadioY_(1.0f), translationX_(0),
          translationY_(0) {}
...
protected:
    ...
    void DrawRectWithPath(const Point& startPoint, int16_t height, int16_t width, const Paint& paint);
    static void DoDrawRectWithPath(BufferInfo& gfxDstBuffer,
                           void* param,
                           const Paint& paint,
                           const Rect& rect,
                           const Rect& invalidatedArea,
