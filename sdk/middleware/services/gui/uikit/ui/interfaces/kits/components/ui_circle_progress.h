...
private:
    ...
    static constexpr int16_t MAX_DATA_NUM = 26;
    static constexpr int16_t MAX_CMD_NUM = 5;
    ...
    void DrawForegroundGradient(BufferInfo& gfxDstBuffer, const Rect& invalidatedArea,
