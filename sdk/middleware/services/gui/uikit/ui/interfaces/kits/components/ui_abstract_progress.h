...
public:
     ...
     *
     * <b>rangeMin</b> and <b>rangeMax</b> can be any value represented by <b>int32_t</b>.
     ...
     * @version 1.0
     */
    void SetRange(int32_t rangeMax, int32_t rangeMin);
    ...
    bool SetForegroundGradient(const LinearGradient& linear, const ColorStop* stops, uint16_t stopCount);
...
protected:
    ...
    void RenderGradientStroke(BufferInfo& gfxDstBuffer, const Rect& invalidatedArea, uint32_t strokeWidth);
    void* AllocBufferForPath(uint32_t size);
#endif
    float* data_ = nullptr;
    uint8_t* cmd_ = nullptr;
    uint32_t dataNum_ = 0;
    uint32_t cmdNum_ = 0;
    LinearGradient foregroundGradient_ = {0};
    ColorStop* foregroundStops_ = nullptr;
    uint16_t foregroundStopCount_ = 0;
