...
public:
     ...
     * @version 1.0
     */
    void SetImageAnimatorSrc(const ImageAnimatorInfo imageSrc[], uint8_t imageNum, uint16_t timeOfUpdate);
     ...
     * @version 1.0
     */
    void SetImageAnimatorSrc(const ImageAnimatorInfo imageSrc[], uint8_t imageNum);
    ...
    /**
     * @brief Sets the attribute value for the end frame of this animator.
     *
     * @param fillMode Indicates the attribute value for the end frame of this animator.
     *                 When a forward playback is performed, the value <b>true</b> indicates setting the end frame of
     *                 this animator to the last one of the image set, and <b>false</b> indicates setting the end frame
     *                 of this animator to the first one of the image set. When a reverse playback is performed,
     *                 the value <b>true</b> indicates setting the end frame of this animator to the first one of
     *                 the image set, and <b>false</b> indicates setting the end frame of this animator to the last one
     *                 of the image set. The default value is <b>true</b>.
     * @see GetFillMode
     * @since 3.0
     * @version 5.0
     */
    ...
    /**
     * @brief Obtains the attribute value of the last frame of this animator.
     *
     * @return Returns <b>true</b> if the last frame of this animator is the last one of the image set when
     *         a forward playback is performed, or if the last frame of this animator is the first one of the image set
     *         when a reverse playback is performed;
     *         returns <b>false</b> if the last frame of this animator is the first one of the image set when
     *         a forward playback is performed, or if the last frame of this animator is the last one of the image set
     *         when a reverse playback is performed.
     *
     * @see SetFillMode
     * @since 3.0
...
protected:
    ...
    void SetSrcWithCache(const char* src);
