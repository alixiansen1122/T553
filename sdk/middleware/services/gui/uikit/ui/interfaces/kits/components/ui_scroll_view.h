...
public:
    ...
    void SetVibrationLenThreshold(uint16_t value)
    {
        vibrationLenThreshold_ = value;
    }

    uint16_t GetVibrationLenThreshold() const
    {
        return vibrationLenThreshold_;
    }
...
private:
    ...
    uint16_t vibrationLenThreshold_;
#endif
};
} // namespace OHOS
