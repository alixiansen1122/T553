...
public:
     ...
     * @version 3.0
     */
    void SetOnRotateListener(OnRotateListener* onRotateListener) override
    {
        list_.SetOnRotateListener(onRotateListener);
    }
     ...
     * @version 3.0
     */
    OnRotateListener*& GetOnRotateListener() override
    {
        return list_.GetOnRotateListener();
    }
#endif
     ...
     * @version 3.0
     */
    void SetOnFocusListener(OnFocusListener* onFocusListener) override
    {
        list_.SetOnFocusListener(onFocusListener);
    }
     ...
     * @version 3.0
     */
    OnFocusListener* GetOnFocusListener() const override
    {
        return list_.GetOnFocusListener();
    }
#endif
