...
public:
    ...
    /**
     * @brief Eases in shaping like a elastic curve. The animation moves fast at first, then slows down and eventually
     *        tends to zero.
     *
     * @param startPos     Indicates the start value of this animation.
     * @param endPos       Indicates the end value of this animation.
     ...
     * @version 1.0
     */
    static int16_t ElasticEaseIn(int16_t startPos, int16_t endPos, uint16_t curTime, uint16_t durationTime);
