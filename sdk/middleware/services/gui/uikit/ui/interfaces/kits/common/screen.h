...
public:
    ...
    /**
     * @brief Obtains the radius of this screen.
     *
     * @return Returns the screen radius.
     * @since 1.0
     * @version 1.0
     */
    uint16_t GetRadius();
    ...
    /**
     * @brief Get screenshot in the specific rect, please remember to call ImageCacheFree in order to release memory
     * @param info Record the screenshot information
     * @param rect Specific area of screenshot, full screen if nullptr
     * @return Returns true if success
     * @since 5.0
     * @version 3.0
     */
    bool GetScreenBitmapByRect(ImageInfo& info, const Rect* rect, float scale = 1.0, bool isClearMem = false);
    ...
    bool GetBitMapFromBuffer(const BufferInfo &srcBuf, ImageInfo& info, const Rect *rect, float scale = 1.0, bool isClearMem = false);
