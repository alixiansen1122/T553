...
public:
    ...
    /**
     * @brief Check if has active animator.
     *
     * @since 1.0
     * @version 1.0
     */
    ...
    /**
     * @brief Get total number of animators.
     */
    uint16_t GetTotalAnimatorNum();

    /**
     * @brief Get number of active animators which was recorded by AnimatorTask().
     */
    uint16_t GetActiveAnimatorNum();
