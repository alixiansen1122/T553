...
{
    Rect rect(GetRect());
    int16_t topRadius = buttonStyles_[styleState_]->GetStyle(STYLE_TOP_BORDER_RADIUS);
    int16_t bottomRadius = buttonStyles_[styleState_]->GetStyle(STYLE_BOTTOM_BORDER_RADIUS);
