...
public:
    ...
    void DrawImage(BufferInfo& gfxDstBuffer, const Rect& area, const Rect& mask,
                   ...
                   uint8_t cmpMode, const uint8_t* imgPhyAddr = nullptr) const;
#else
    void DrawImage(BufferInfo& gfxDstBuffer, const Rect& area, const Rect& mask,
                   const uint8_t* image, OpacityType opa, uint8_t pxBitSize, ColorMode colorMode,
    ...
    void DrawArcLablePath(BufferInfo& gfxDstBuffer, const LabelLetterInfo& letterInfo,
...
private:
    ...
    static void Draw3DTriangleTrueColorBilinear(const TriangleScanInfo& triangle, const ColorMode bufferMode);
    ...
    void BlendAlphaWithSoftWare(const uint8_t* src,
                                const Rect& srcRect,
                                uint32_t srcStride,
                                ColorMode srcMode,
                                uint32_t color,
...
#if CAPABILITY_HWDRAW_LETTER_VECTOR
    bool DrawLetterVectorPath(BufferInfo& gfxDstBuffer, const LabelLetterInfo& letterInfo) const;
#endif

#if defined(CAPABILITY_SWDRAW_LETTER_BITMAP) && CAPABILITY_SWDRAW_LETTER_BITMAP
    void DrawLetterBitmap(BufferInfo& gfxDstBuffer, const LabelLetterInfo& letterInfo) const;
#endif
};
} // namespace OHOS
