...
{
    ListVerticalAddTestAutoSize001();
    ListVerticalRemoveTestAutoSize001();
    ListVerticalRemoveTestAutoSize002();
    ListHorAddTestAutoSize001();
    ListHorRemoveTestAutoSize001();
    ListHorRemoveTestAutoSize002();
    return container_;
}

void UITestListLayout::ListVerticalAddTestAutoSize001()
{
    if (container_ == nullptr) {
        return;
    }
    ...
    // 2: half of screen's width  3: 3 tiems of blank zoom
    empty->SetPosition(0, 0, Screen::GetInstance().GetWidth() / 2, g_blank * 3);
    container_->Add(empty);
    
    positionY_  = 3 * g_blank; //  3: 3 tiems of blank zoom
...
void UITestListLayout::ListVerticalRemoveTestAutoSize001()
{
    if (container_ == nullptr) {
        return;
    }
...
void UITestListLayout::ListVerticalRemoveTestAutoSize002()
{
    if (container_ == nullptr) {
        return;
    }
    UILabel* label = GetTitleLabel("UILIst高度自适应 RemoveAll");
    label->Resize(Screen::GetInstance().GetWidth() - g_blank, Screen::GetInstance().GetHeight());
    container_->Add(label);
    label->SetPosition(TEXT_DISTANCE_TO_LEFT_SIDE, positionY_ + g_blank);
...
void UITestListLayout::ListHorAddTestAutoSize001()
{
    if (container_ == nullptr) {
        return;
    }
...
void UITestListLayout::ListHorRemoveTestAutoSize001()
{
    if (container_ == nullptr) {
        return;
    }
...
void UITestListLayout::ListHorRemoveTestAutoSize002()
{
    if (container_ == nullptr) {
        return;
    }
