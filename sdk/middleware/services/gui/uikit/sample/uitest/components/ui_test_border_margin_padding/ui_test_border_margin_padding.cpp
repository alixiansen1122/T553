...
static ImageAnimatorInfo g_imageAnimatorInfo[4] = {
    {RES_PATH"image_animator_0.bin", {84, 108}, 116, 116, IMG_SRC_FILE_PATH},
...
void UITestBorderMarginPadding::InitUIToggleButton()
{
    ...
    // 20 : offset
    layoutButton_->SetPosition(Screen::GetInstance().GetWidth() - BUTTON_GROUP_WIDTH + 20, 0, BUTTON_GROUP_WIDTH,
                               Screen::GetInstance().GetHeight() - BACK_BUTTON_HEIGHT);
    layoutButton_->SetRows(8);  // 8 ： ro
    layoutButton_->SetCols(1);
...
void UITestBorderMarginPadding::InitAdapterData()
{
...
void UITestBorderMarginPadding::SetUp()
{
    ...
    container_->SetPosition(0, 0, Screen::GetInstance().GetWidth(),
                            Screen::GetInstance().GetHeight() - BACK_BUTTON_HEIGHT);
    // 40: x
    scroll_->SetPosition(40, 0, Screen::GetInstance().GetWidth() - BUTTON_GROUP_WIDTH,
                         Screen::GetInstance().GetHeight() - BACK_BUTTON_HEIGHT);
...
void UITestBorderMarginPadding::UIKitUITestBorderMarginPaddingTest001()
{
    AddTitle("UIView");
...
void UITestBorderMarginPadding::UIKitUITestBorderMarginPaddingTest002()
{
    AddTitle("UILabel");
...
void UITestBorderMarginPadding::UIKitUITestBorderMarginPaddingTest011()
{
    ...
    imageView->SetSrc(RES_PATH"blue_rgb888.bin");
