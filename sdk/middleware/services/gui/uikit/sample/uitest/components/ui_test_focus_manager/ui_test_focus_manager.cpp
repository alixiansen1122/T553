...
void UITestFocusManager::InitListener(UIViewGroup* group)
{
    UIView* view2 = CreateTestUILabel(group, 195, 5, "2", true); /* 195: x, 5: y */
    if (clearFocusListener_ == nullptr) {
    ...
    /* 50: x, 300: width, 400: height */
    btnViewGroup->SetPosition(50, 400, 300, 400);
    container_->Add(btnViewGroup);
    UIKit_Focus_Manager_Test_002(btnViewGroup);
}
...
void UITestFocusManager::UIKit_Focus_Manager_Test_001()
{
    ...
    /* 150: x ; 288: width */
    label->SetPosition(150, TEXT_DISTANCE_TO_TOP_SIDE, 288, TITLE_LABEL_DEFAULT_HEIGHT);
    label->SetText("焦点管理效果 ");
    label->SetFont(DEFAULT_VECTOR_FONT_FILENAME, FONT_DEFAULT_SIZE);
    UIViewGroup* viewGroup = CreateTestUIViewGroup(container_, true, false);
    /* 500: width, 350: height */
    viewGroup->SetPosition(VIEW_DISTANCE_TO_LEFT_SIDE2, VIEW_DISTANCE_TO_TOP_SIDE, 500, 350);
    ...
    CreateTestUILabel(viewGroup5, 35, 5, "5", true);                 /* 35: x, 5: y */
    CreateTestUILabel(viewGroup3, 50, 70, "6", true);                /* 50: x, 70: y */
    ...
    CreateTestUILabel(viewGroup6, 200, 5, "10", true);                /* 200: x, 5: y */
    ...
    InitListener(viewGroup1);
    FocusManager::GetInstance()->RequestFocus(viewGroup1->GetChildById("1"));
}

void UITestFocusManager::UIKit_Focus_Manager_Test_002(UIViewGroup* btnViewGroup)
{
    if (requestFocusByDirectionLeftListener_ == nullptr) {
...
UILabelButton* UITestFocusManager::SetUpButton(std::string title, int16_t x, int16_t y, UIViewGroup* viewGroup,
