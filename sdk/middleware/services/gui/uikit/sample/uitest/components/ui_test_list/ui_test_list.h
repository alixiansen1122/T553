...
#ifndef UI_TEST_LIST_H
#define UI_TEST_LIST_H
...
namespace OHOS {
class UITestList : public UITest, UIView::OnClickListener, ListScrollListener {
public:
    UITestList() {}
    ~UITestList() override {}
    void SetUp() override;
...
private:
    ...
    void SetUpButton(UILabelButton* btn, const char* title, int16_t width);
