...
const int16_t BUTTON_WIDTH = 140;
...
void UITestAnimator::SetUp()
{
    if (container_ == nullptr) {
        ...
        image_->SetSrc(RES_PATH"/tiger_path.bin");
...
void UITestAnimator::UIKitAnimatorTestCircEasing002()
{
    ...
    // 2: count of btn
    positionX_ = BUTTON_WIDTH * 2 + DELTA_Y_COORDINATE * 2 + TEXT_DISTANCE_TO_LEFT_SIDE;
    positionY_ = 0;
...
void UITestAnimator::SetSineEaseEvent(UIView& view)
{
    if (&view == sineEaseInBtn_) {
