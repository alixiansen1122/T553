...
static const float FULL_TPLAY_FRAMERATE_LIMIT = 60.0;
/* DEFAULT_BITRATE: 2 * 1024 */
static const uint32_t FULL_TPLAY_BITRATE_LIMIT = 2048;
/* TPLAY_FULL_LIMIT_RESULITON: 500 * 500 */
static const uint32_t FULL_TPLAY_RESULITON_LIMIT   = 250000;
static const uint32_t HI_RET_SKIP_PACKET   = 1;
static const uint32_t EXTRA_MBUF_LEN = 1500;
static const uint32_t GOP_SIZE = 1;
