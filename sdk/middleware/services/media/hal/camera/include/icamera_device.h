...
public:
     ...
     *
     * @param settings Indicates the camera parameters, including the sensor frame rate and 3A parameters. 3A stands
     ...
     * @version 1.0
     */
    virtual CamRetCode UpdateSettings(const void *value, int size) = 0;
     ...
     *
     * After metadata reporting is disabled, the metadata is not reported by calling {@link OnResult}. To enable
     * metadata reporting, you must call {@link EnableResult}.
     *
