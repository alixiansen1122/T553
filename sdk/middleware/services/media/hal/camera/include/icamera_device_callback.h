...
* Description: icamera device callback
...
public:
    ...
    /**
     * @brief Called to report metadata related to the camera device. For details about the reporting mode,
     * see {@link SetResultMode}.
     *
     ...
     * You can call {@link GetEnabledResults} to obtain enabled metadata and call {@link DisableResult} to
     * disable metadata reporting.
     *
     * @since 1.0
     * @version 1.0
     */
