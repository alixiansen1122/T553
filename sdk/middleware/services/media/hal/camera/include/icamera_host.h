...
public:
     ...
     *
     * This function provides the entry to the camera service. You must use this function to obtain an
     * <b>ICameraHost</b> instance before performing other operations.
     *
     * @param serviceName Indicates the name of the <b>ICameraHost</b> instance to obtain. Currently, the name is
     * fixed at <b>camera_service</b>.
     *
     * @return Returns the <b>ICameraHost</b> instance if the operation is successful;
     ...
     *
     * By calling this function, you can obtain the <b>ICameraDevice</b> instance and operate the specific camera
     * device mapping to the instance.
     *
     * @param cameraId Indicates the ID of the camera device, which can be obtained by calling {@link GetCameraIds}.
     ...
     * @param isEnable Specifies whether to turn on or off the flash. The value <b>true</b> means to turn on the
     * flash, and <b>false</b> means the opposite.
     *
     * @return Returns <b>NO_ERROR</b> if the operation is successful; returns an error code defined
     * in {@link CamRetCode} otherwise.
     *
