...
#define DIAG_CMD_AUDIO_SAVE_SWS_EFFECT_REQ      diag_cmd_id_comb(0x2E)
#define DIAG_CMD_AUDIO_SAVE_SEE_EFFECT_REQ      diag_cmd_id_comb(0x2f)
...
#define DIAG_CMD_LOG_FILE_TEST          diag_cmd_id_comb(0x73)
