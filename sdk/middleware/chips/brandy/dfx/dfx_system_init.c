...
const diag_cmd_reg_obj_t g_diag_default_cmd_tbl[] = {
    ...
    { DIAG_CMD_AUDIO_SWS_EFFECT_REQ, DIAG_CMD_AUDIO_SEE_EFFECT_REQ, diag_aef_param_trans },
    { DIAG_CMD_AUDIO_SAVE_SWS_EFFECT_REQ, DIAG_CMD_AUDIO_SAVE_SEE_EFFECT_REQ, diag_aef_param_save },
#endif
};
