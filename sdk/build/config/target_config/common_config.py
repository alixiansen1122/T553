...
component_set = {
    ...
    'media': ['audio_capture', 'audio_manager', 'audio_service', 'audio_stream', 'audio_utils',
              ...
              'camera_codec_hw', 'hdi_camera_intf', 'plugin_demuxer_raw', 'audio_modem_port', 'audio_decrypt', 'ogg',
              'plugin_muxer_wav', 'dtcf', 'audio_recorder', 'dtcf_manager', 'plugin_muxer_raw', 'plugin_demuxer_ogg'],
    ...
    'media_mini': ['audio_capture', 'audio_manager', 'audio_service', 'audio_stream', 'audio_utils',
              'media_sample_wrapper', 'player', 'media_common', 'audio_bluetooth_port', 'audio_hw',
              'audio_primary_port','format_hw', 'hmf_demuxer', 'media_hal_common', 'plugin_demuxer_hmf',
              'plugin_demuxer_mjpeg', 'plugin_protocol_https', 'audio_port_common', 'plugin_demuxer_raw', 'ogg'],
    'media_target4': ['audio_manager', 'audio_service', 'audio_stream', 'audio_utils', 'media_common', 'audio_hw',
              ...
              'audio_port_common', 'media_sample_wrapper', 'audio_decrypt'],
    'gpu': ['gfx_rm', 'gpu'],
    'gpu_test': ['test_gpu'],
    'graphic_uikit': ['cjson_static', 'display_gfx', 'display_gralloc', 'display_layer', 'graphic_input', 'graphic_service',
                'freetype_static', 'graphic_ui', 'graphic_utils', 'qrcodegen', 'icu4c', 'harfbuzz', 'uikit_ext','zlib_static', 'png_static', 'jpeg_static',
                'graphics_ui_traceui'],
    ...
    'gnss_set': ['gnss_header', 'gnss_brandy', 'pdr_fusion', 'gnss_at_samples'],
    'tiot_set': ['tiot_driver'],
    'volte_set' : ['ims'],
    'nfc_set' : ['nfc_middleware_src', 'nfc_header', 'samples'],
    'ohos_set' : ['bootstrap', 'samgr', 'ams', 'bms', 'bms_sign_mode', 'ace', 'ace_adapt', 'permission', 'appverify', 'jerryscript','js_player', 'js_audio_capturer', 'baidumapcomponent', 'brightness', 'netstack_http', 'websocket', 'i18n', 'ace_http', 'ace_websocket', 'ace_watchface', 'ace_ext',
                  'resmgr', 'syspara', 'utils_kv_store', 'native_file', 'storage_jsapi', 'svr_dynload', 'location_common', 'location_utils', 'locator_sdk', 'location_locator', 'location_gnss', 'location_gnss_hdi', 'js_audio_recorder',
                  'location_gnss_utils', 'location_gnss_emulator', 'location_sample', 'sensor_client', 'sensor_service', 'sensor_hdi', 'sensor_sample', 'ace_calendar', 'sensor_hdi_acc_simulator', 'sensor_hdi_acc_alg_simulator',
                  'sensor_hdi_barometer', 'sensor_hdi_gyroscope', 'sensor_hdi_hr_counter', 'sensor_hdi_pedometer', 'sensor_hdi_wear_detection'],
    ...
    'msg_center_service' : ['xiaodu_navi', 'xiaodu_voice', 'xiaodu_navi_vector', 'hc_demo_msg', 'auto_ota_msg', 'alipay_msg',
                            'app_store_msg', 'dial_market', 'device_msg', 'remote_msg'],
    'sikey': ['skdriver', 'sk_service', 'cjson_static', 'netstack_http', 'websocket', 'ohos_startup'],
}
