...
class upg_base_info:
    def __init__(self):
        ...
        self.ssb_bin         = os.path.join(self.output, "acore", "brandy-ssb-diting", "ssb.bin")
        self.recovery_bin    = os.path.join(self.output, "acore", "brandy-diting-r", "recovery.bin")
        self.app_bin         = os.path.join(self.output, "acore", "brandy-diting", "application.bin")
