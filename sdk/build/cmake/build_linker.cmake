...
if(${USE_KCONFIG})
file(STRINGS "${ROOT_DIR}/build/config/target_config/${CHIP}/menuconfig/${CORE}/${BUILD_TARGET_NAME}.config" LOS_CONFIG_LIST ENCODING "UTF-8")
# 过滤掉空行和注释行
list(FILTER LOS_CONFIG_LIST EXCLUDE REGEX "^[ \t]*$")
list(FILTER LOS_CONFIG_LIST EXCLUDE REGEX "^[ \t]*#")
foreach (CONFIG ${LOS_CONFIG_LIST})
    list(APPEND LDS_DEFINES "-D"${CONFIG})
endforeach()
endif()
