...
#define IP6IN4TMR_NAME        , "ip6in4_tmr"
...
//#define MEMP_SYS_TIMEOUT sizeof(struct timer_entry)
...
void lwip_lowpower_inc(lowpower_module lm);
void lwip_lowpower_dec(lowpower_module lm);
