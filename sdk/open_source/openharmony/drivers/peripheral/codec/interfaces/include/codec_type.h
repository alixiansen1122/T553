...
typedef struct {
    ...
    uint32_t uvOffset;          /**< Buffer offset */
} CodecBufferInfo;
...
typedef enum {
    ...
    MEDIA_MIMETYPE_IMAGE_MJPEG,    /**< MJPEG image */
...
typedef struct {
     ...
     */
    int (*OnEvent)(uintptr_t comp, uintptr_t appData, EventType event,
     ...
     * @return Returns <b>0</b> if the operation is successful; returns a non-zero value otherwise.
     */
    int (*InputBufferAvailable)(uintptr_t comp, uintptr_t appData, InputInfo *inBuf);
     ...
     * @return Returns <b>0</b> if the operation is successful; returns a non-zero value otherwise.
     */
    int (*OutputBufferAvailable)(uintptr_t comp, uintptr_t appData, OutputInfo *outBuf);
} CodecCallback;
...
typedef struct {
    ...
    uint32_t bufferNum;  /**< Range number of output buffers. Report when decode the first frame,
