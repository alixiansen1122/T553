...
typedef bool (*TryToFreeImgCallback)(void);
typedef bool (*TryToFreeFontCacheCallback)(void);
...
typedef struct {
    ...
    void (*RegisterTryToFreeImgCallback)(TryToFreeImgCallback callback);

    void (*RegisterTryToFreeFontCacheCallback)(TryToFreeFontCacheCallback callback);
} GrallocFuncs;
