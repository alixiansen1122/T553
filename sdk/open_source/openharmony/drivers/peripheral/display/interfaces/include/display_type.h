...
enum {
    ...
    HBM_USE_MEM_FONT = (1 << 8),        /**< assign memory size from requester */
    HBM_USE_MEM_YUV = (1 << 9),         /**< assign memory size for YUV Buffer from requester */
    HBM_USE_MEM_PATH = (1 << 10),       /**< assign memory size for path data */
    HBM_USE_MEM_BUFMAP = (1 << 11),     /**< assign memory size for map buffer */
    HBM_USE_MEM_MULTI_IMG = (1 << 12),  /**< assign memory size for multi image cache */
    HBM_USE_MEM_JPEG_DATA = (1 << 13),  /**< assign memory size for JPEG data */
};
...
typedef enum {
    ...
    PIXEL_FMT_A1,               /**< A1 format */
    PIXEL_FMT_A2,               /**< A2 format */
    PIXEL_FMT_A4,               /**< A4 format */
    PIXEL_FMT_A8,               /**< A8 format */
...
typedef struct {
    ...
    bool isCompressed;        /**< Is in Compressed Mode or not */
} ISurface;
