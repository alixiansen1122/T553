...
// ohos-hisi begin
// avoid redefined for SENSOR_NAME_MAX_LEN by liteos_m
...
enum SensorTypeTag {
	...
	// ohos-hisi begin
    SENSOR_TYPE_VSENSOR_EXPAND_START        = 0x1000,   /* 4096 */
    SENSOR_TYPE_VSENSOR_ACCELEROMETER_ALG_SIMU,         /**< ACCELEROMETER ALG sensor */
    SENSOR_TYPE_VSENSOR_WEAR_ALG,                       /**< WEAR ALG sensor */
    SENSOR_TYPE_VSENSOR_PRESS_ALG,                      /**< PRESS ALG sensor */
	// ohos-hisi end
...
// ohos-hisi begin
/**
 * @brief Accelerometer sensor data structure
 */
struct AccelData {
...
/**
 * @brief Gyro sensor data structure
 */
struct GyroData {
    /** Gyro data X-axis */
    int16_t axisX;
