...
struct SensorInterface {
     ...
     *
     * @param sensorTypeId Indicates the sensor group ID.
     ...
     * @version 1.0
     */
    int32_t (*Register)(int32_t sensorTypeId, RecordDataCallback cb);
     ...
     * @version 1.0
     */
    int32_t (*Unregister)(int32_t sensorTypeId, RecordDataCallback cb);
    ...
    // ohos-hisi begin
    /**
    * @brief Get the data of the specified sensor stored.
    *
    * @param sensorTypeId Indicates the ID of a sensor type. For details, see {@link SensorTypeId}.
    * @param sensorData Indicates the data of sensor stored For details, see {@link SensorData}.
    * @return Returns <b>0</b> if get sensor data successfully; returns a non-zero value otherwise.
    *
    * @since 5
    */
    int32_t (*GetSensorData)(int32_t sensorTypeId, SensorData *sensorData);
    // ohos-hisi end
};
