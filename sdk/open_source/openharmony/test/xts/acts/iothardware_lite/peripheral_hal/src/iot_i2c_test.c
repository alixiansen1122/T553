...
const unsigned int COMPILABILITY_TEST_I2C_DEVICE = 2; // 根据实际情况设置，此处使用I2C_BUS_2
const unsigned short COMPILABILITY_TEST_I2C_DEVICE_ADDR = 0xFFFF; // 根据实际情况设置I2C从机地址
#define DATA_LEN 3
