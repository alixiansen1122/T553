...
#define MAX_NUM_OF_OPENED_FILES 99
...
LITE_TEST_CASE(UtilsFileReliTestSuite, testCreateFileAfterMaxFilesOpened, Function | MediumTest | Level1)
{
    ...
    for (int i = 0; i < MAX_NUM_OF_OPENED_FILES; i++) {
        ...
        int size = sprintf_s(fileName32, sizeof(fileName32), "%s%d", "/user/testReli101-", j);
        if (size < 0) {
    ...
    // Open the 33th file
    char fileName33[LENGTH_OF_FILE_NAME_BUF] = { 0 };
    (void)sprintf_s(fileName33, sizeof(fileName33), "%s%d", "/user/testReli101-", MAX_NUM_OF_OPENED_FILES + 1);
...
LITE_TEST_CASE(UtilsFileReliTestSuite, testDeleteFileAfterMaxFilesOpened, Function | MediumTest | Level1)
{
    ...
    // Delete file
    char* fileName1 = "/user/testReli101-1";
    UtilsFileClose(fd32[0]);   
...
LITE_TEST_CASE(UtilsFileReliTestSuite, testCopyFileAfterMaxFilesOpened, Function | MediumTest | Level1)
{
    ...
    // Copy file
    char* fileName1 = "/user/testReli101-1";
    char* fileNameCopy = "/user/testReliCopy";
...
LITE_TEST_CASE(UtilsFileReliTestSuite, testMoveFileAfterMaxFilesOpened, Function | MediumTest | Level1)
{
    ...
    // Move file
    char* fileName1 = "/user/testReli101-1";
    char* fileNameMove = "/user/testReliMove";
...
{
    char* fileName1 = "/user/testReli102a";
    char* fileName2 = "/user/testReli102b";
    // Create file
...
LITE_TEST_CASE(UtilsFileReliTestSuite, testFileOperFlow002, Function | MediumTest | Level1)
{
    char* fileName1 = "/user/testReli102a";
    char* fileName2 = "/user/testReli102b";
    char* fileName3 = "/user/testReli102c";
    // Create file
    int fd1 = UtilsFileOpen(fileName1, O_RDWR_FS | O_CREAT_FS, 0);
    UtilsFileWrite(fd1, g_def, strlen(g_def));
    UtilsFileClose(fd1);
...
{
    char* fileName1 = "/user/testReli103a";
    char* fileName2 = "/user/testReli103b";
...
LITE_TEST_CASE(UtilsFileReliTestSuite, testEmptyFileOperFlow002, Function | MediumTest | Level1)
{
    char* fileName1 = "/user/testReli103a";
    char* fileName2 = "/user/testReli103b";
    char* fileName3 = "/user/testReli103c";
    // Create an empty file
    int fd1 = UtilsFileOpen(fileName1, O_RDWR_FS | O_CREAT_FS, 0);
    UtilsFileClose(fd1);
    // Copy file
