...
typedef enum SensorTypeId {
	...
	// ohos-hisi begin
    SENSOR_TYPE_ID_VSENSOR_EXPAND_START        = 0x1000,   /* 4096 */
    SENSOR_TYPE_ID_VSENSOR_ACCELEROMETER_ALG_SIMU,         /**< ACCELEROMETER ALG sensor */
    SENSOR_TYPE_ID_MAX,                                    /**< Maximum number of sensor types */
	// ohos-hisi end
} SensorTypeId;
