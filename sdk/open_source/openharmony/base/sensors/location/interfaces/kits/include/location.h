...
public:
    ...
    inline double GetNorthVelocity() const
    {
        return velocityNorth_;
    }

    inline void SetNorthVelocity(double velocityNorth)
    {
        velocityNorth_ = velocityNorth;
    }

    inline double GetEastVelocity() const
    {
        return velocityEast_;
    }

    inline void SetEastVelocity(double velocityEast)
    {
        velocityEast_ = velocityEast;
    }

    inline double GetDescendVelocity() const
    {
        return velocityDescend_;
    }

    inline void SetDescendVelocity(double velocityDescend)
    {
        velocityDescend_ = velocityDescend;
    }
    ...
    inline int32_t GetStatusNumber() const
    {
        return statusNumber_;
    }

    inline void SetStatusNumber(int32_t statusNumber)
    {
        statusNumber_ = statusNumber;
    }
...
private:
    ...
    float velocityNorth_;
    float velocityEast_;
    float velocityDescend_;
    int64_t uncertaintyOfTimeSinceBoot_;
    int32_t locationSourceType_;
    int32_t statusNumber_;
    std::string uuid_;
};
} // namespace Location
} // namespace OHOS
