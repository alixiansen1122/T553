...
MutexId WorkRecordStatistic::workRecordStatisticMutex_ = MutexCreate(nullptr);
...
std::shared_ptr<WorkRecordStatistic> WorkRecordStatistic::GetInstance()
{
    if (instance_ == nullptr) {
        AutoLock lock(workRecordStatisticMutex_);
        if (instance_ == nullptr) {
...
WorkRecordStatistic::WorkRecordStatistic()
{
