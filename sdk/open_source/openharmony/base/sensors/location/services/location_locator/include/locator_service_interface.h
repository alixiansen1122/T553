...
#ifndef LOCATOR_SERVICE_INTERFACE_H
#define LOCATOR_SERVICE_INTERFACE_H
...
const char LOCATOR_SERVICE[] = "LocatorService";
const char LOCATOR_FEATURE[] = "LocatorFeature";

namespace OHOS {
namespace Location {

struct LocatorInterface {
    INHERIT_IUNKNOWN;
...
#endif // LOCATOR_SERVICE_INTERFACE_H
