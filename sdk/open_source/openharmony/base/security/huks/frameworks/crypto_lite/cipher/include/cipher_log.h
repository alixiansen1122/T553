...
#define CIPHER_LOG_D(...) CipherLog(CIPHER_LOG_LEVEL_D, __func__, __LINE__, __VA_ARGS__)
#define CIPHER_LOG_I(...) CipherLog(CIPHER_LOG_LEVEL_I, __func__, __LINE__, __VA_ARGS__)
#else
#define CIPHER_LOG_E printf
#define CIPHER_LOG_D printf
#define CIPHER_LOG_I printf
#endif
#ifdef __cplusplus
}
#endif
