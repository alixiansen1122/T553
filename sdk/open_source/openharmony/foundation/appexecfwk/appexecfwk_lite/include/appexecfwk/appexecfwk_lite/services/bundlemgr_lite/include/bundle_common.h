...
const char PROFILE_KEY_MODULE_ABILITY_SRCPATH[] = "srcPath";
...
#else
const char DEFAULT_DEVICE_TYPE[] = "liteWearable";
const char INSTALL_PATH[] = APP_BASE_DIR"user/ace/run";
const char DATA_PATH[] = APP_BASE_DIR"user/ace/data";
const char SYSTEM_BUNDLE_PATH[] = APP_BASE_DIR"system/ace/sys";
const char THIRD_SYSTEM_BUNDLE_PATH[] = APP_BASE_DIR"system/ace/vendor";
const char UNINSTALL_THIRD_SYSTEM_BUNDLE_JSON[] = APP_BASE_DIR"user/ace/etc/uninstalled_delbundle.json";
const char THIRD_SYSTEM_BUNDLE_JSON[] = APP_BASE_DIR"user/ace/etc/third_system_bundle.json";
const char JSON_PATH[] = APP_BASE_DIR"user/ace/etc/bundles/";
const char JSON_PATH_NO_SLASH_END[] = APP_BASE_DIR"user/ace/etc/bundles";
// store bundle permissions for IAM
const char PERMISSIONS_PATH[] = APP_BASE_DIR"user/ace/etc/permissions";
// Original IDE version
const char ASSET_JS_PATH[] = "/assets/js/default";
// IDE version 5.0 and above
const char ASSET_JS_PATH_MAINABILITY[] = "/assets/js/MainAbility";
// IDE version below 5.0
const char ASSET_JS_PATH_DEFAULT[] = "/assets/js/default";
...
const char TMP_RESOURCE_DIR[] = APP_BASE_DIR"user/ace/run/tmpResource";
...
const uint8_t MAX_THIRD_BUNDLE_NUMBER = 60;
