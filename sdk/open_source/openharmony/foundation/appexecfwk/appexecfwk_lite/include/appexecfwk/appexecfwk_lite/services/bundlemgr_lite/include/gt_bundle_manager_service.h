...
public:
    ...
    void ScanPackages(InstallerCallback ScanPackagesResultCallback);
...
private:
    ...
    void ScanThirdApp(const char *appDir, const List<ToBeInstalledApp *> *systemPathList, InstallerCallback ScanPackagesResultCallback);
