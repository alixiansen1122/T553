...
/**
 * @brief Defines the maximum length of the system capabiliy name.
 */
#define MAX_SYSCAP_NAME_LEN 64

/**
 * @brief Defines the maximum num of system capabilities.
 */
...
#else
    /** Pointer to the path for storing data files of the application. */
    char *dataPath;
