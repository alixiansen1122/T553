...
/**
 * @brief Scans all installed packages in the system and triggers the provided callback with the result.
 *
 * This function initiates a scan of all installed packages, and the result is returned through the specified
 * {@link InstallerCallback}. The callback will receive the result status of the package scanning operation.
 *
 * @param installerCallback Indicates the callback to be invoked for notifying the package scan result.
 * @return Returns <b>true</b> if the scan operation is successfully initiated; returns <b>false</b> otherwise.
 *
 * @since 1.0
 * @version 1.0
 */
bool ScanPackages(InstallerCallback installerCallback);
