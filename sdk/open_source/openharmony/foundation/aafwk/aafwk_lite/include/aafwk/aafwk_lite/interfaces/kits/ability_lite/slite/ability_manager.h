 ...
 *
 * @param want Indicates the pointer to the {@link Want} structure containing information about the ability to start.
 * @param type Indicates the transition animator type, value can refer to enum class OHOS::TranstitionType
 * @param want Indicates whether support slide back.
 * @return Returns <b>0</b> if this function is successfully called; returns another value otherwise.
 */
int StartAbilityWithAnimation(const Want *want, uint8_t type, bool enableSlideBack);
