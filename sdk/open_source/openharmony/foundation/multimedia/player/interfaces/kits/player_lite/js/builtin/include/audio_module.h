...
public:
    ...
    /**
     * the getter of audio srcInner property
     *
     * @param thisVal Indicates function execute context
     * @param args Indicates the function arguments
     * @param argsSize Indicates the size of function arguments
    ...
    /**
     * the setter of audio src list property
     *
     * @param thisVal Indicates function execute context
     * @param args Indicates the function arguments
     * @param argsSize Indicates the size of function arguments
    ...
    /**
     * the setter of audio srcInner property
     *
     * @param thisVal Indicates function execute context
     * @param args Indicates the function arguments
     * @param argsSize Indicates the size of function arguments
    ...
    /**
     * the setter of play in the background.
     *
     * @param thisVal Indicates function execute context
     * @param args Indicates the function arguments
     * @param argsSize Indicates the size of function arguments
    ...
    /**
     *the getter of play in the background.
     *
     * @param thisVal Indicates function execute context
     * @param args Indicates the function arguments
     * @param argsSize Indicates the size of function arguments
    ...
    /**
     *the GetAlbumInfo method of audio.
     *
     * @param thisVal Indicates function execute context
     * @param args Indicates the function arguments
     * @param argsSize Indicates the size of function arguments
...
private:
    static void SuccessCallBack(const JSIValue thisVal, const JSIValue args, JSIValue outputValue);

    static void FailCallBack(const JSIValue thisVal, const JSIValue args, const char *errStr);
    ...
    static bool CheckInputParam(const JSIValue thisVal, const JSIValue *args, uint8_t argsSize);
};
