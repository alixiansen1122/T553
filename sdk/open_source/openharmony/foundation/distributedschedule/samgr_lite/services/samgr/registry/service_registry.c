...
BOOL __attribute__((weak)) SAMGR_RegisterClientApi(const char *service, const char *feature, IUnknown *iUnknown)
{
    (void)service;
    (void)feature;
    (void)iUnknown;
...
IUnknown *__attribute__((weak)) SAMGR_UnregisterClientApi(const char *service, const char *feature)
{
    (void)service;
    (void)feature;
    return NULL;
