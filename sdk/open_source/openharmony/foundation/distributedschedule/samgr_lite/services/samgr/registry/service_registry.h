...
BOOL SAMGR_RegisterClientApi(const char *service, const char *feature, IUnknown *iUnknown);
IUnknown *SAMGR_UnregisterClientApi(const char *service, const char *feature);
