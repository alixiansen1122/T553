...
typedef struct ExtendInfo ExtInfo;
 ...
 * response are sent.
 * @param request Indicates the pointer to the request.
 * @param response Indicates the pointer to the response.
 ...
 * @see SAMGR_SendSharedDirectRequestEx
 * @since 1.0
 * @version 1.0
 */
...
/**
 * @brief Sends a request and extend information of a caller to the feature thread. The handler is directly
 * called to process the request and extend information without using the message processing functions.
 * (Customized function for the broadcast service)
 *
 * This function is used to publish topics for the {@link Broadcast} service to broadcast messages. \n
 * The value of reference counting is incremented by one each time this function is called. \n
 *
 * @param id Indicates the pointer to the IDs of services or features, to which the request and
 * extend information are sent.
 * @param request Indicates the pointer to the request.
 * @param extInfo Indicates the pointer to the extend information.
 * @param ref Indicates the reference counting.
 * @param handler Indicates the function for handling the request and response. This parameter
 * cannot be <b>NULL</b>.
 * @return Returns <b>EC_SUCCESS</b> if the request and response are sent successfully; returns
 ...
 * @version 1.0
 */
int32 SAMGR_SendSharedDirectRequestEx(const Identity* id, const Request* req,
...
/**
 * @brief Gets the extend information of a request.
 *
 * This function is used to publish topics for the {@link Broadcast} service to broadcast messages. \n
 *
 * @param request Indicates the pointer to the request.
 * @return Returns <b>NULL</b> if the request is not directly called; returns
 * not null if the request and response fail to be sent.
 * @attention
 *  <ul><li>Ensure the function is called in the Handler function. </li></ul>
 * @since 1.0
 * @version 1.0
 */
...
Request* SAMGR_AllocRequestMsg(uint16 direct, uint16 coreNum, uint16 serviceId, uint16 len);
