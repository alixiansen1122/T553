...
#ifndef ENABLE_MODULE_CALENDAR
#define ENABLE_MODULE_CALENDAR 1
#endif
 ...
 */
// conflict with macro FEATURE_ACELITE_HI_LOG_PRINTF
 ...
 */
// The lazy loading mode needs the support of the renderTick event to use it.
 ...
 */
#define FEATURE_MODULE_MESSAGE_CENTER

/**
 * support watch connect
 */
#define FEATURE_MODULE_WATCH_CONNECT

/**
 * support file and storage module
 */
//xx00 #define FEATURE_MODULE_STORAGE
...
/**
 * support battery module
 */
#define FEATURE_MODULE_BATTERY

/**
 * support geolocation module
 */
...
#ifndef APP_BASE_DIR
//#define APP_BASE_DIR "bin/vs/sd0p0/"
#define APP_BASE_DIR "/user/app/"
#endif

#define DEFAULT_PROFILER_MSG_PATH APP_BASE_DIR"user/log/"

#define PROFILER_ENABLE_FLAG_FILE APP_BASE_DIR"user/data/profiler_enable"

#define RUNTIME_MODE_FILE_PATH APP_BASE_DIR"user/data/jsparser_enable"
...
//#else
//#define FEATURE_COMPONENT_IMAGE_PICKER
//#endif
...
/**
 * JS_TOUCH_EVENT_SUPPORT
 */
#define JS_TOUCH_EVENT_SUPPORT

/**
 * support cipher module
 */
