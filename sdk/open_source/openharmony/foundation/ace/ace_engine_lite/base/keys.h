...
enum {
...
#ifdef FEATURE_COMPONENT_WEBIMAGE
    KEYWORD(WEBIMAGE, webimage) // tag name
#endif
    KEYWORD(IMAGE_ANIMATOR, image-animator) // tag name
#ifdef FEATURE_COMPONENT_IMAGE_PICKER
    KEYWORD(IMAGE_RANGE, image-range) // image range for image picker
    KEYWORD(IMAGE_SELECTED_RANGE, image-selected-range) // selected image range for image picker
#endif
    ...
    // ohos begin
    // list-item adaptive
    KEYWORD(LONG_TEXT, longText) // common attributes
    // ohos end
...
#ifdef FEATURE_COMPONENT_LISTEXT
    KEYWORD(MENU_ITEM, arclist-item) // arclist-item tag name
    KEYWORD(LIST_EXT, arclist) // arclist tag name
#endif // FEATURE_COMPONENT_LISTEXT
#ifdef FEATURE_COMPONENT_SCROLL
    KEYWORD(SCROLL, scroll) // scroll tag name
#endif // FEATURE_COMPONENT_SCROLL
#ifdef FEATURE_DATE_FORMAT
    KEYWORD(LONG, long)
#endif
    ...
    KEYWORD(ORIENTATION, text-orientation) // text rotation
    ...
    KEYWORD(ROTATE_INPUT, rotate_input)
    ...
    KEYWORD(SCROLLBAR, scrollbar) // list scroll bar
#ifdef FEATURE_COMPONENT_ANALOG_CLOCK
    ...
    KEYWORD(TEXT_ALIGN_VERTICAL, textAlignVertical) //text style vertical type
    ...
    KEYWORD(BAIDUMAP, baidumap) // baidumap tag name
