...
const char * const CanvasComponent::FUNC_CLEAR = "clear";
...
jerry_value_t CanvasComponent::DrawImage(const jerry_value_t func,
                                      const jerry_value_t context,
                                      const jerry_value_t args[],
                                      const jerry_length_t argsNum)
{
                                      ...
                                      const jerry_length_t argsNum)
{
    ...
    if (argsNum < ArgsCount::NUM_3) {
        ...
        int16_t x =  IntegerOf(args[ArgsIndex::IDX_1]);
        int16_t y =  IntegerOf(args[ArgsIndex::IDX_2]);
        component->paint_.Rotate(angle, x, y);
    }
    return UNDEFINED;
}
...
jerry_value_t CanvasComponent::Clear(const jerry_value_t func,
                                      const jerry_value_t context,
                                      const jerry_value_t args[],
                                      const jerry_length_t argsNum)
{
                                              ...
                                              int16_t &height)
{
    ...
    // Parameters are objects retrieved from HML
        ...
        if (imageCom != nullptr) {
            ...
            imageName = GetImageObjectParam(args);
...
char* CanvasComponent::GetImageObjectParam(const jerry_value_t args[])
{
