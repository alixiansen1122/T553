...
private:
    ...
    void SetTextAlignVertical(UILabel& label, const AppStyleItem* styleItem) const;
    ...
    // parse js text rotate angle style to ui_label
    void SetTextRotateAngle(UILabel &label, jerry_value_t attrValue);
    UILabel uiLabel_;
    uint8_t fontSize_;
    char* fontFamily_;
    char* textValue_;
    uint8_t overflowMode_;
    uint16_t rotateAngle_ = 0;
};
} // namespace ACELite
} // namespace OHOS
