...
protected:
    ...
    static const char * const ROTATE_SCROLL;
    static const char * const FUNC_SCROLL;
    static UIView *GetScrollView(const JSValue dom, const jerry_length_t size);

private:
    class ViewOnTouchListener final : public UIView::OnTouchListener,public UIView::OnDragListener
    {
    public:
        ViewOnTouchListener();
        ~ViewOnTouchListener();
        ...
        void SetOnTouchStartListener(ViewOnTouchStartListener *startListener);
        void SetOnTouchEndListener(ViewOnTouchEndListener *endListener);
        void SetOnTouchCancelListener(ViewOnTouchCancelListener *cancelListener);
        void SetOnTouchMoveListener(ViewOnTouchMoveListener *moveListener);
    ...
    void SetViewOnTouchListener(UIView &view);
    ...
    /**
     *  @brief This function enable descendant class to do special operation by overriding this.
     */
    virtual bool RefreshRectCallback()
    {
        return false;
    }
    ...
    void SetRotateEventListener(UIView& view, jerry_value_t eventFunc);
#ifdef JS_TOUCH_EVENT_SUPPORT
    void SetTouchStartEventListener(UIView &view, jerry_value_t eventFunc,  uint16_t eventTypeId);
    void SetTouchMoveEventListener(UIView &view, jerry_value_t eventFunc, uint16_t eventTypeId);
    void SetTouchEndEventListener(UIView &view, jerry_value_t eventFunc, uint16_t eventTypeId);
    void SetTouchCancelEventListener(UIView &view, jerry_value_t eventFunc, uint16_t eventTypeId);
    void SetKeyBoardEventListener(jerry_value_t eventFunc, uint16_t eventTypeId);
#endif
    void SetKeyInputEventListener(UIView &view, jerry_value_t eventFunc, uint16_t eventTypeId);
    /**
    ...
    /**
     * @brief Obtains the X coordinate of the component origin.
     */
    static JSValue GetX(const JSValue func, const JSValue dom, const JSValue args[], const jerry_length_t size);

    /**
     * @brief Obtains the Y coordinate of the component origin.
     */
    static JSValue GetY(const JSValue func, const JSValue dom, const JSValue args[], const jerry_length_t size);
    ...
    ViewOnRotateListener *onRotateListener_;
#ifdef JS_TOUCH_EVENT_SUPPORT
    ViewOnTouchStartListener *onTouchStartListener_;
    ViewOnTouchMoveListener *onTouchMoveListener_;
    ViewOnTouchCancelListener *onTouchCancelListener_;
...
#endif
    KeyInputEventListener *onKeyInputListener_;
    /**
    ...
    static const char * const FUNC_GETX;
    static const char * const FUNC_GETY;
};
} // namespace ACELite
} // namespace OHOS
