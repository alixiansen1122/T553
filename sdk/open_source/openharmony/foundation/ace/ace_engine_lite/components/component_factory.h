...
#if FEATURE_COMPONENT_LISTEXT
#include "menu_item_component.h"
#include "list_ext_component.h"
#endif // FEATURE_COMPONENT_LISTEXT
#if FEATURE_COMPONENT_SCROLL
#include "scroll_component.h"
#endif // FEATURE_COMPONENT_SCROLL

#if FEATURE_COMPONENT_WEBIMAGE
#include "webimage_component.h"
#endif // FEATURE_COMPONENT_WEBIMAGE
...
#if FEATURE_COMPONENT_LISTEXT
            case K_MENU_ITEM:
                component = new MenuItemComponent(options, children, styleManager);
                break;
            case K_LIST_EXT:
                component = new ListExtComponent(options, children, styleManager);
                break;
#endif // FEATURE_COMPONENT_LISTEXT
#if FEATURE_COMPONENT_WEBIMAGE
            case K_WEBIMAGE:
                component = new WebImageComponent(options, children, styleManager);
                break;
#endif // FEATURE_COMPONENT_WEBIMAGE
#if FEATURE_COMPONENT_SCROLL
            case K_SCROLL:
                component = new ScrollComponent(options, children, styleManager);
                break;
#endif // FEATURE_COMPONENT_SCROLL
#ifdef FEATURE_COMPONENT_ANALOG_CLOCK
            case K_CLOCK_HAND:
...
#ifdef FEATURE_COMPONENT_BAIDUMAP
            case K_BAIDUMAP:
                component = new BaiduMapComponent(options, children, styleManager);
                break;
#endif // FEATURE_COMPONENT_BAIDUMAP
            default:
                component = nullptr;
