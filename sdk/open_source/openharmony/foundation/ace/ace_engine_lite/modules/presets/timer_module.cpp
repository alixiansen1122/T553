...
void TimerModule::Init()
{
    ...
    const char * const setAppGlobalInterval = "setAppGlobalInterval";
    const char * const setAppGlobalTimeout = "setAppGlobalTimeout";
    ...
    CreateNamedFunction(setAppGlobalInterval, SetAppGlobalInterval);
    CreateNamedFunction(setAppGlobalTimeout, SetAppGlobalTimeout);
}
                                       ...
                                       bool isAppGlobal)
{
    ...
    arguments->isAppGlobal = isAppGlobal;
